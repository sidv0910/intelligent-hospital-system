...
<link rel="stylesheet" type="text/css" href="PatientUpdateProfile.css"> </link>
<script type="text/javascript" src="PatientUpdateProfile.js"> </script>
</head>
<body>
...
<td> 
<select name="marital">
	<option value="" disabled selected hidden> <%= marital %>  </option>
    <option value="Married"> Married </option>
    <option value="Unmarried"> Unmarried </option>
</select>
<input type="hidden" name="hidden" value="<%= marital %>">
</td>
<td> Age : </td>
<td> <input type="number" value="<%= age %>" name="age" id="age" class="number"> </td>
<td> Profession : </td>
<td> <input type="text" value="<%= profession %>" size="41" name="profession" id="profession"> </td>
</tr>
<tr>
<td> Mobile : </td>
<td> <input type="number" value="<%= mobile %>" name="mobile" id="mobile" class="number"> </td>
<td> Address : </td>
<td colspan="3"> <input type="text" value="<%= address %>" size="118" name="address" id="address"> </td>
</tr>
</table>
</center>
</div>
...
<tr>
<td> Name : </td>
<td> <input type="text" value="<%= emgName %>" size="41" name="emgName" id="emgName"> </td>
<td> Relation : </td>
<td> <input type="text" value="<%= emgRelation %>" size="41" name="emgRelation" id="emgRelation"> </td>
<td> Contact : </td>
<td> <input type="number" value="<%= emgContact %>" name="emgContact" id="emgContact" class="number"> </td>
</tr>
</table>
</center>
</div>
